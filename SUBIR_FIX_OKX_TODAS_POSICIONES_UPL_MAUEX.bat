...
chcp 65001 >nul
setlocal
title MAUex - fix OKX todas posiciones UPL
cd /d "%~dp0"

echo.
echo ============================================
echo   MAUex - OKX todas posiciones UPL
echo ============================================
echo.
echo Este BAT sube:
echo   worker.js
...
set "COMMIT_MSG=%~1"
if "%COMMIT_MSG%"=="" set "COMMIT_MSG=Fix OKX UPL todas posiciones"
...
git add -- worker.js SUBIR_FIX_OKX_TODAS_POSICIONES_UPL_MAUEX.bat
if errorlevel 1 (
  echo.
