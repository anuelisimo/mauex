...
chcp 65001 >nul
setlocal
title MAUex - fix fila Bybit total
cd /d "%~dp0"

echo.
echo ============================================
echo   MAUex - fix fila Bybit total
echo ============================================
echo.
echo Este BAT sube:
echo   worker.js
...
set "COMMIT_MSG=%~1"
if "%COMMIT_MSG%"=="" set "COMMIT_MSG=Fix fila Bybit total capital"
...
git add -- worker.js SUBIR_FIX_BYBIT_FILA_TOTAL_MAUEX.bat
if errorlevel 1 (
  echo.
