...
chcp 65001 >nul
setlocal
title MAUex - fix OKX unrealized PnL
cd /d "%~dp0"

echo.
echo ============================================
echo   MAUex - fix OKX unrealized PnL
echo ============================================
echo.
echo Este BAT sube:
echo   worker.js
...
set "COMMIT_MSG=%~1"
if "%COMMIT_MSG%"=="" set "COMMIT_MSG=Fix OKX unrealized PnL en capital"
...
git add -- worker.js SUBIR_FIX_OKX_PNL_UNREALIZED_MAUEX.bat
if errorlevel 1 (
  echo.
