...
git add -- app.js firebase.js index.html worker.js COPIAR_WORKER_CLOUDFLARE.bat SUBIR_FIX_SYNC_PRECIOS_CAPITAL_MAUEX.bat DIAGNOSTICAR_SYNC_PRECIOS_CAPITAL_MAUEX.bat DIAGNOSTICAR_WORKER_VARIABLES_MAUEX.bat
if errorlevel 1 (
  echo.
