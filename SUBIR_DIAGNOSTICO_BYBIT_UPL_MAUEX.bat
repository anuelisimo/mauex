...
chcp 65001 >nul
setlocal
title MAUex - diagnostico Bybit UPL
cd /d "%~dp0"

echo.
echo ============================================
echo   MAUex - diagnostico Bybit UPL
echo ============================================
echo.
echo Este BAT sube:
echo   worker.js
...
set "COMMIT_MSG=%~1"
if "%COMMIT_MSG%"=="" set "COMMIT_MSG=Agregar diagnostico Bybit UPL"
...
git add -- worker.js SUBIR_DIAGNOSTICO_BYBIT_UPL_MAUEX.bat
if errorlevel 1 (
  echo.
