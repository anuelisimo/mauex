...
chcp 65001 >nul
setlocal
title MAUex - fix UPL todos exchanges
cd /d "%~dp0"

echo.
echo ============================================
echo   MAUex - UPL en todos los exchanges
echo ============================================
echo.
echo Este BAT sube:
echo   worker.js
...
set "COMMIT_MSG=%~1"
if "%COMMIT_MSG%"=="" set "COMMIT_MSG=Fix UPL en capital de todos los exchanges"
...
git add -- worker.js SUBIR_FIX_UPL_TODOS_EXCHANGES_MAUEX.bat
if errorlevel 1 (
  echo.
