...
chcp 65001 >nul
setlocal
title MAUex - fix mobile tarjetas
cd /d "%~dp0"

echo.
echo ============================================
echo   MAUex - fix mobile tarjetas
echo ============================================
echo.
echo Este BAT sube:
echo   app.js
...
set "COMMIT_MSG=%~1"
if "%COMMIT_MSG%"=="" set "COMMIT_MSG=Fix mobile cards visibility"
...
git add -- app.js firebase.js styles.css index.html SUBIR_FIX_MOBILE_TARJETAS_MAUEX.bat
if errorlevel 1 (
  echo.
...
echo.
echo Listo: fix mobile subido a GitHub.
echo En el celular, cerra y volve a abrir MAUex o refresca fuerte para limpiar cache.
echo.
pause
exit /b 0
